...
async def start_command(client, message):
    ...
    join_button = InlineKeyboardButton("ᴊᴏɪɴ 🌸", url="https://t.me/PbxTeraBox")
    developer_button = InlineKeyboardButton("ᴏᴡɴᴇʀ 👻", url="https://t.me/ll_BAD_MUNDA_ll")
...
async def handle_message(client, message: Message):
    ...
    reply_msg = await message.reply_text("sᴇᴀʀᴄʜɪɴɢ ᴛʜᴇ  ᴍᴇᴅɪᴀ...👻")
